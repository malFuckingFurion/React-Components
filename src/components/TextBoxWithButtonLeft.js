...
class TextBoxWithButtonLeft extends React.Component {
  render() {
    return (
      <div className="section-title-2 mb-20 grey-bk text-left">
...
TextBoxWithButtonLeft.propTypes = {
  span: PropTypes.string,
  title: PropTypes.string,
  text: PropTypes.string,
};

export default TextBoxWithButtonLeft;
